...
config_flags.DEFINE_config_file('agent', 'agents/pgfql.py', lock_config=False)


def main(_):
    # Set up logger.
    exp_name = "{}_{}_{}".format("IFQL", FLAGS.env_name, FLAGS.seed)
    setup_wandb(project='pgfql', group=FLAGS.run_group, name=exp_name)
